	...
	const provider4 = vscode.languages.registerCompletionItemProvider(
		'symphony',
		{
			provideCompletionItems(document: vscode.TextDocument, position: vscode.Position) {
				...
				const doc4: any = new vscode.MarkdownString("Pushes 'static {num}' to the top of the stack");
				...
				const doc5: any = new vscode.MarkdownString("Pushes 'pointer {num}' to the top of the stack");
				...
				const doc6: any = new vscode.MarkdownString("Pushes 'this {num}' to the top of the stack");
				...
				const doc7: any = new vscode.MarkdownString("Pushes 'that {num}' to the top of the stack");
				...
				const doc8: any = new vscode.MarkdownString("Pushes 'temp {num}' to the top of the stack");
	...
	const provider7 = vscode.languages.registerCompletionItemProvider(
		'symphony',
		{
			provideCompletionItems(document: vscode.TextDocument, position: vscode.Position) {
				...
				const cmd4 = new vscode.CompletionItem('static', vscode.CompletionItemKind.Method);
				cmd4.insertText = new vscode.SnippetString("static ${0:num}");
				const doc4: any = new vscode.MarkdownString("Pops the value on the top of the stack into 'static {num}'");
				cmd4.documentation = doc4;
				const cmd5 = new vscode.CompletionItem('pointer', vscode.CompletionItemKind.Method);
				cmd5.insertText = new vscode.SnippetString("pointer ${0:num}");
				const doc5: any = new vscode.MarkdownString("Pops the value on the top of the stack into 'pointer {num}'");
				cmd5.documentation = doc5;
				const cmd6 = new vscode.CompletionItem('this', vscode.CompletionItemKind.Method);
				cmd6.insertText = new vscode.SnippetString("this ${0:num}");
				const doc6: any = new vscode.MarkdownString("Pops the value on the top of the stack into 'this {num}'");
				cmd6.documentation = doc6;
				const cmd7 = new vscode.CompletionItem('that', vscode.CompletionItemKind.Method);
				cmd7.insertText = new vscode.SnippetString("that ${0:num}");
				const doc7: any = new vscode.MarkdownString("Pops the value on the top of the stack into 'that {num}'");
				cmd7.documentation = doc7;
				const cmd8 = new vscode.CompletionItem('temp', vscode.CompletionItemKind.Method);
				cmd8.insertText = new vscode.SnippetString("temp ${0:num}");
				const doc8: any = new vscode.MarkdownString("Pops the value on the top of the stack into 'temp {num}'");
				cmd8.documentation = doc8;
